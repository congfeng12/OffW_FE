       ...
       <!-- 页头 -->
        ...
        <div style="width: 1024px;background-color: #FFFFFF;margin: 0 auto 0;border-radius: 6px;margin-top:40px;"> 
          ...
          <div style="width:1024px;height: 50px;text-align: left;">
            <h1 class="noselect" style="font-size: 16px;margin: 0px 0px 0px 40px;line-height: 50px;font-weight:900;">广告申请</h1>
          </div>
          <!-- 分割线 -->
          ...
          <div style="width:223px;text-align: right;position:absolute;top:150px;">
            <!-- 标题 -->
            <h1 style="margin: 60px 50px 0px 0px;font-size:18px;">用户名：</h1>
            <!-- 内容 -->
            <h1 style="margin: 70px 50px 0px 0px;font-size:18px;">广告类型：</h1>
            <!-- 选择板块 -->
            <h1 style="margin: 65px 50px 0px 0px;font-size:18px;">广告标题：</h1>
            <!-- 选择板块 -->
            <h1 style="margin: 75px 50px 0px 0px;font-size:18px;">图片链接：</h1>
            <!-- 选择板块 -->
            <h1 style="margin: 75px 50px 0px 0px;font-size:18px;">广告地址：</h1>
          </div>
          <!-- 内容 -->
          <div style="width:800px;height: auto;">
            <!-- 用户名 -->
            <div style="height:auto;margin: 60px 115px 0px 240px!important;">
              <input id="title" readonly type="text" name="addtitle" class="pl_add_input" v-model="username">
            </div>
            <!-- 问题类型 -->
            <div style="height: auto;margin:10px 0px 0px 240px;">
              <select v-model="selectval" class="pl_add_select">
                <option value="">请选择广告类型</option>
                <option value="1">头版广告</option>
                <option value="2">次级版位广告</option>
                <option value="3">单邮件广告</option>
              </select>
            </div>
            <!-- 标题 -->
            <div id="edidiv" style="margin: 55px 0px 0px 240px!important;height:auto;">
               <input id="title" type="text" name="addtitle" class="pl_add_input" v-model="title_adv">
            </div>
            <!-- 图片链接地址 -->
            <div id="edidiv" style="margin: 55px 0px 0px 240px!important;height:auto;">
               <input id="title" type="text" name="addtitle" class="pl_add_input" placeholder="http://ip:port/******/" v-model="img_url">
            </div>
            <!-- 广告链接地址 -->
            <div id="edidiv" style="margin: 55px 0px 0px 240px!important;height:auto;">
               <input id="title" type="text" name="addtitle" class="pl_add_input" placeholder="http://ip:port/******/" v-model="adv_url">
            </div>
            <!-- 发布按钮 -->
            <div style="height:auto;width:200px;margin: 40px 0px 0px 370px;">
              <button v-bind:disabled="isShowBatchSend" class="pl_add_button" type="" @click="">申请</button>
            </div>
